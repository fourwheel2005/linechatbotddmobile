...
public class LineMessageService {
    ...
    public void sendWelcomeCard(String toUserId) {
        try {
            ...
            // Fallback ถ้าการ์ดส่งไม่ได้ ให้ส่งเป็นข้อความธรรมดาแทน (ชี้ทางไป 2 บริการเหมือนบนการ์ด)
            sendTextMessage(toUserId, "สวัสดีครับคุณลูกค้า 🙏✨\n" +
                    "ยินดีต้อนรับสู่ ร้านทันใจ ผ่อนง่ายใช้แค่บัตรประชาชนใบเดียว\n\n" +
                    "ลูกค้าสามารถพิมพ์คำว่า 'สนใจผ่อนบอลลูน' หรือ 'จำนำ iCloud' ส่งมาได้เลยนะครับ 👇");
        }
    }
